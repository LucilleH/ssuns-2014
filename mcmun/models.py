...
class FacAdNameApp(models.Model):
	...
	name_2 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 2")
	name_3 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 3")
	name_4 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 4")
	name_5 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 5")
	name_6 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 6")
	name_7 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 7")
	name_8 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 8")
	name_9 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 9")
	name_10 = models.CharField(max_length=255, null=True, blank=True, verbose_name="full name 10")
